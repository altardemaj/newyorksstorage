...
const initialForm = { address: "", date: "", size: "Not too sure", type: "Personal", items: "", duration: "3–6 months", details: "", firstName: "", lastName: "", email: "", phone: "" };
