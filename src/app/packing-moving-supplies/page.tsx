...
export const metadata = createPageMetadata("Packing & Moving Supplies", "Ask New York S. Storage about boxes and packing supplies for your move, with delivery options available.", "/packing-moving-supplies");
export default function SuppliesPage() {
  return <>
    <JsonLd data={[
      webPageSchema({ path: "/packing-moving-supplies", name: "Packing & Moving Supplies | New York S. Storage", description: "Ask New York S. Storage about boxes and packing supplies for your move, with delivery options available." }),
      breadcrumbSchema([{ name: "Home", path: "/" }, { name: "Packing Supplies", path: "/packing-moving-supplies" }]),
    ]} />
    <PageHero eyebrow="Packing & moving supplies" title="The right box makes every move easier" description="We stock boxes in multiple sizes and moving supplies to help protect, label, and organize your belongings." />
